 ...
 * for heat controller with:
 * - NTC 5k
 * - NR230 valve servo control
 * - AC 230V pump
 * - Thermostat
 * Developed for customer Attila Toth
 * Improved version based on data from the working heat system 15.01.2023
 */
